...
log "start tag_prefix=$TAG_PREFIX end_at=$END_AT interval_s=$INTERVAL_SECONDS wire_every_n=$WIRE_EVERY_N pc_launch_prefix=${PC_LAUNCH_PREFIX:-none} serial_lock_wait_s=$SERIAL_LOCK_WAIT_SECONDS"
iteration=0
