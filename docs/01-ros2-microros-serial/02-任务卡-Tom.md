...
> **⚠️ Phase B（T3/T4/T5/T8）以 `05-PhaseB攻坚计划.md` 为权威**（2026-06-19 因 F103 换芯 + 真机到位重排）。
> 本文下方 T3~T7 是 F401 时代旧版，已被 05 文档的 T3/T4/T5/T8 替代——执行 Phase B 看 05 文档，别用下面的旧卡。
> 关键路径：T4 骨架 + T3 agent(并行) → **M1 起 session(今日首要)** → T5a 单向 → T5b 双向 → M4 量化。
