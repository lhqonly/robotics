...
#ifndef EXO_MOTOR_MSGS__MSG__DETAIL__JOINT_STATE__TYPE_SUPPORT_H_
#define EXO_MOTOR_MSGS__MSG__DETAIL__JOINT_STATE__TYPE_SUPPORT_H_
...
#endif  // EXO_MOTOR_MSGS__MSG__DETAIL__JOINT_STATE__TYPE_SUPPORT_H_
