...
#ifndef EXO_MSGS__MSG__DETAIL__EXO_STATUS__TYPE_SUPPORT_H_
#define EXO_MSGS__MSG__DETAIL__EXO_STATUS__TYPE_SUPPORT_H_
...
#endif  // EXO_MSGS__MSG__DETAIL__EXO_STATUS__TYPE_SUPPORT_H_
