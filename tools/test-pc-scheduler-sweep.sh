...
assert_contains "$summary" \
  "profile cmd_rate_hz=200 cmd_catchup_max=1 qos=best_effort depth=1 tracking=sampled status_every_n=40 sample_window=1024 summary_period_s=5.0 link_health_period_s=5.0 startup_grace_s=3.0 executor_threads=2 require_core_metrics=0 require_health_pass=0" \
